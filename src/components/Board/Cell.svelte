<script>
	...
	import { errorValue } from '../Controls/ActionBar/Resetstack';
	...
	$: isError = errorValue.number === value && 
				 errorValue.index.x === (cellX - 1) && 
				 errorValue.index.y === (cellY - 1);
</script>
