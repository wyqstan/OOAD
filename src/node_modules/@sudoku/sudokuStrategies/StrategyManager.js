...
//        console.log(tmm);
        for (const strategy of this.strategies) {
            ...
            if (JSON.stringify(tmm) !== JSON.stringify(candidates)) {
                ...
                // this.strategies_used.push(strategy.getName());
                // console.log(this.strategies_used)
//                console.log(this.candidatesHistory)
        ...
        this.candidatesHistory["final candidate"] = JSON.parse(JSON.stringify(tmm));
        console.log(this.candidatesHistory)
        // 所有算法执行完后返回
